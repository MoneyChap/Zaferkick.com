    ...
    return (
        <section className={styles.container}>
            <div className={styles.card}>
                ...
                <p className={styles.subtitle}>We’re getting ready to launch something amazing.</p>

                <div className={styles.socials}>
                    <a href="https://t.me/zaferkick" target="_blank" rel="noreferrer" className={styles.socialBtn}>
